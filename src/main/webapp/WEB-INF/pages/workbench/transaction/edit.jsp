...
<script type="text/javascript">
	...
	$(function () {
		...
		$("#saveTranBtn").click(function () {
			...
			//发送请求
			$.ajax({
				url:'workbench/transaction/reviseTransactionById.do',
				data:{
					owner:owner,
					money:money,
					name:name,
...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="selectContacts" class="form-control" style="width: 300px;" placeholder="请输入联系人名称，支持模糊查询">
						    <span class="glyphicon glyphicon-search form-control-feedback"></span>
						  </div>
						</form>
					</div>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-accountName" value="${tran.customerId}" placeholder="支持自动补全，输入客户不存在则新建">
			</div>
		...
		<div class="form-group">
			...
			<label for="inquire-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="activity" data-target="#findMarketActivity"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="activityId" value="${tran.activityId}">
				<input type="text" class="form-control" id="inquire-activitySrc" value="${tran.activityId}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="contactsId" value="${tran.contactsId}">
