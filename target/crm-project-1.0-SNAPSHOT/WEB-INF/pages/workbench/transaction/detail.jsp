...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${tran.customerId} <small>￥${tran.money}</small></h3>
		</div>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${stages}" var="sta">
			<%--当前交易所在阶段--%>
			<c:if test="${sta.value==tran.stage}">
				<span class="glyphicon glyphicon-map-marker mystage" data-toggle="popover" data-placement="bottom" data-content="${sta.value}" style="color: #90F790;"></span>
				-----------
			</c:if>
			<c:if test="${sta.orderNo<tran.orderNo}">
				<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="${sta.value}" style="color: #90F790;"></span>
				-----------
			</c:if>
			<c:if test="${sta.orderNo>tran.orderNo}">
				<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="${sta.value}"></span>
				-----------
			</c:if>
		</c:forEach>
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${bun}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		...
		<div style="position: relative; top: 100px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable" class="table table-hover" style="width: 900px;">
					...
					<tbody>
					<c:forEach items="${tranHistories}" var="trhi">
						<tr>
							<td>${trhi.stage}</td>
							<td>${trhi.money}</td>
							<td>${trhi.expectedDate}</td>
							<td>${trhi.createTime}</td>
							<td>${trhi.createBy}</td>
						</tr>
					</c:forEach>
					</tbody>
